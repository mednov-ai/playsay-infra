...
Git revision at the latest recorded infrastructure change: `d360bf7` on
`release/1.001.00` and `codex/migrate-ax41-dev-prod`.
...
- prod secrets were generated independently in the prod cluster; dev runtime secrets were not copied into prod;
...
Remaining gates are release module completion and retry of aborted release jobs,
immutable prod image promotion, runtime rollout, credential/login/material/object
