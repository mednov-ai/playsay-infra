...
Production release `release/1.001.06` promotes platform commit `99b6432fa065cbc4976233166f8d5f2966706035` after the complete 11-module Jenkins dispatcher succeeded. It contains the JPG annotation-scroll fix, live exercise-answer synchronization and the homework detail/opening fix. The main runtime digests are API `sha256:923b8b771173d9b2649017b74d402e8e7b52315cdc6b52254e751439dc653c5f`, web `sha256:d991d386cd015557db11b623beb8f9dca7635c4203891299162402ec2eeab7fb`, collaboration `sha256:0b7fa7d6a60f02eec3484aef7fc7c081b54e6233c33c4cc8744650787b9a53bc` and vocabulary `sha256:a0078708600da555dc52768ea8b896822c6861af46e72eb2f41db9ec09b70db1`; every promoted workload renders `repository@sha256`. A pre-release logical backup under `/var/backups/playsay/release-1.001.06-20260726T090005Z` passed archive-list and checksum validation. All 15 ArgoCD applications reached `Synced/Healthy`. Direct `online.honey.school` and the Selectel alias `online.honeyschool.ru` returned the identical complete JS bundle and API `UP`; all four direct/RF PKCE callbacks returned the Keycloak login page with the unchanged issuer `https://ops.honey.school/keycloak/realms/playsay`. RF TLS 1.2 succeeds and TLS 1.3 is rejected with protocol-version alert. Roll back by returning the production root to `release/1.001.04`; do not rebuild images.
