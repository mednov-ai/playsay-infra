...
EOF
  ...
  helm upgrade --install jenkins jenkins/jenkins \
    ...
    --set agent.containerCap=1 \
    --set agent.garbageCollection.enabled=true \
    --set agent.garbageCollection.namespaces=jenkins \
    --set agent.garbageCollection.timeout=300 \
    --set agent.resources.requests.cpu=50m \
    --set agent.resources.requests.memory=128Mi \
    --set agent.resources.limits.cpu=300m \
    --set agent.resources.limits.memory=384Mi \
